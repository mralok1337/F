...
if (!isset($_SESSION['authenticated'])) {
    $stored_hashed_password = '$2a$12$FIbVWaO/lT2FeRwkFUnSgeVDQFo21PR.y3V90K4VufF.RL.VwPw9m'; // Use PASSWORD_DEFAULT hash u can use this site https://phppasswordhash.com/ for generate ur password >  Gunakan hash PASSWORD_DEFAULT Anda dapat menggunakan situs ini https://phppasswordhash.com/ untuk menghasilkan kata sandi Anda
